...
#[derive(Debug)]
pub struct RuneOmenProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RuneOmenProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RuneOmen processing");
    
    let mut processor = RuneOmenProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RuneOmenProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RuneOmenProcessor::new(false);
